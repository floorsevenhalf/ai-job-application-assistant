const FILL_REASON_MESSAGES: Record<string, string> = {
  ...
  value_not_written: "原生 setter 未写入值",
  value_reverted_on_focus: "网页在 focus 事件中同步清除了值",
  value_reverted_on_input: "网页在 input 事件中同步清除了值",
  value_reverted_on_change: "网页在 change 事件中同步清除了值",
  value_reverted_on_blur: "网页在 blur 事件中同步清除了值",
